...
namespace OmniRoute.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260501140646_AddAiApiKeyConfigJson")]
    partial class AddAiApiKeyConfigJson
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OmniRoute.Domain.Entities.AiApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AiApiKeys", (string)null);
                });

            modelBuilder.Entity("OmniRoute.Domain.Entities.FollowUpTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OmniRoute.Domain.Entities.Lead", b =>
                {
                    ...
                    b.Property<int>("BasePriorityScore")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OmniRoute.Domain.Entities.MasterDataItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OmniRoute.Domain.Entities.NotificationConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("NotificationType", "TargetRole")
                        .IsUnique();
            ...
            modelBuilder.Entity("OmniRoute.Domain.Entities.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("EscalatedReason")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
            ...
            modelBuilder.Entity("OmniRoute.Domain.Entities.FollowUpTask", b =>
                {
                    b.HasOne("OmniRoute.Domain.Entities.Lead", "Lead")
                        .WithMany()
